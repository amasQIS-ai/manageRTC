        ...
        <div className="content">
          ...
          <div className="card">
            <div className="card-body">
              <div className="mb-3">
                <p>
                  At SmratHR, we value your privacy and are committed to
                  protecting your personal data. This Privacy Policy explains
                  how we collect, use, disclose, and safeguard your information
                  when you access our HR admin platform. Please read this policy
                  carefully.
                </p>
              </div>
              <div>
                ...
                <ul className="list-styled mb-3">
                  ...
                  <li className="d-flex align-items-baseline mb-2">
                    ...
                    Username, password, IP address, and other access
                    credentials.
                  </li>
              ...
              <div>
                ...
                <ul className="list-styled mb-3">
                  <li className="d-flex align-items-baseline mb-2">
                    <i className="ti ti-point-filled fs-10 me-1" />
                    To authorized service providers who assist in our HR
                    processes.
                  </li>
                  <li className="d-flex align-items-baseline">
                    <i className="ti ti-point-filled fs-10 me-1" />
              ...
              <div>
                ...
                <p>
                  ...
                  use of the HR admin platform signifies your acceptance of any
                  updates.
                </p>
              </div>
            </div>
