                  ...
                  <table className="table table-nowrap mb-0">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <h6>
                            <Link to={routes.dealsDetails}>Collins</Link>
                          </h6>
                        </td>
                      ...
                      <tr>
                        <td>
                          <h6>
                            <Link to={routes.dealsDetails}>Konopelski</Link>
                          </h6>
                        </td>
                        <td>Proposal Made</td>
                        <td>$3,15,000</td>
                      ...
                      <tr>
                        <td>
                          <h6>
                            <Link to={routes.dealsDetails}>Adams</Link>
                          </h6>
                        </td>
                        <td>Contact Made</td>
                        <td>$8,40,000</td>
                      ...
                      <tr>
                        <td>
                          <h6>
                            <Link to={routes.dealsDetails}>Schumm</Link>
                          </h6>
                        </td>
                        <td>Quality To Buy</td>
                        <td>$6,10,000</td>
                      ...
                      <tr>
                        <td>
                          <h6>
                            <Link to={routes.dealsDetails}>Wisozk</Link>
                          </h6>
                        </td>
                        <td>Presentation</td>
                        <td>$4,70,000</td>
                  ...
                  <table className="table table-nowrap mb-0">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <h6>
                            <Link to={routes.leadsDetails}>Collins</Link>
                          </h6>
                        </td>
                        <td>
                          <div className="d-flex align-items-center file-name-icon">
                      ...
                      <tr>
                        <td>
                          <h6>
                            <Link to={routes.leadsDetails}>Konopelski</Link>
                          </h6>
                        </td>
                        <td>
                          <div className="d-flex align-items-center file-name-icon">
                      ...
                      <tr>
                        <td>
                          <h6>
                            <Link to={routes.leadsDetails}>Adams</Link>
                          </h6>
                        </td>
                        <td>
                          <div className="d-flex align-items-center file-name-icon">
                      ...
                      <tr>
                        <td>
                          <h6>
                            <Link to={routes.leadsDetails}>Schumm</Link>
                          </h6>
                        </td>
                        <td>
                          <div className="d-flex align-items-center file-name-icon">
                      ...
                      <tr>
                        <td>
                          <h6>
                            <Link to={routes.leadsDetails}>Wisozk</Link>
                          </h6>
                        </td>
                        <td>
                          <div className="d-flex align-items-center file-name-icon">
